...
//     const HoneyotFactory = await ethers.getContractFactory("Honeypot");
...
//     const honeypotedAttack: Attack = await AttackFactory.deploy(honeypotedBank.address);
//     await honeypotedAttack.deployed();

//     return { 
//       bank, attack, deployer, attacker,honeypotedAttack, honeypot, honeypotedBank
//     }
//   };
...
//     const attackBalance = ethers.utils.formatEther(await attack.getBalance());
...
//     const {honeypotedBank, honeypotedAttack, attacker} = await loadFixture(dep);
...
//     await expect(
//       honeypotedAttack.connect(attacker).attack({
//         value: ethers.utils.parseEther("1.0")
//       })
...
//   it("doesnthoneypot regular users", async function() {
...
//     await expect(await honeypotedBank.withdraw()).to.changeEtherBalances(
//       [honeypotedBank, deployer],
//       [ethers,utils.parseEther("-0.5"), initialAmount]
//     );
//   })
// });